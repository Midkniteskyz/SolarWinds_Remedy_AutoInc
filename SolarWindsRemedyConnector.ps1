...
# Test connection to the Prod Remedy Server. Change to Alterante if unavailable.
...
function Set-RemedyTemplate {
    ...
    begin {
        ...
        $TemplateCollection = @{
            Org1 = @{
                "Assigned Group 1" = "<GUID>"
                "Assigned Group 2" = "<GUID>"
            }
            Org2 = @{
                "Assigned Group 1" = "<GUID>"
                "Assigned Group 2" = "<GUID>"         
...
function Update-SWAlert {
    ...
    begin {
        ...
        # SWIS PowerShell is required on the SolarWinds Server
...
# $RemedyCustomer = "joe.someone"
# $RemedySummary = "Test Summary"
# $RemedyNotes = "Test Notes"
# $SW_Severity = "Warning"
# $RemedyEnvironment = "Production"
# $RemedyOrganization = "Org1"
# $RemedyAssignedGroup = "Assigned Group 1"
# $RemedyTenant = "Tenant 1"
# $SW_AlertID = "4"
$RemedyHost = (Test-ServerConnection -Test -Verbose)
...
Write-Host "Transformed data to be sent to Remedy`nRemedy Host:`n$RemedyHost`nImpact/Urgnecy: $Impact/$Urgency`nEnvironment: $IncEnv`nTemplate: $RemedyTemplate`nIncident Number: $IncidentNumber"
